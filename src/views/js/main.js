...
//global variable to get the window.scrollY calculation out of the updatePositions function.
var scroll = 0;
var tick = false;
//Callback function for scroll event
function onScroll() {
  scroll = window.scrollY/1250;
  onTick();
}
//Function to request animation frame upon scroll event inorder to trigger updatePositions function.
//Thus disallowing the re-layout.
function onTick() {
  if(!tick) {
...
function updatePositions() {
  ...
  //Use style.transform instead of style.left as it is rendered more faster.
